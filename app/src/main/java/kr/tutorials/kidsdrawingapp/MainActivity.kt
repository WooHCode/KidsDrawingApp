package kr.tutorials.kidsdrawingapp
        ...
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { permissions ->
            permissions.entries.forEach {
                ...
                if (isGranted) {
                    Toast.makeText(
                        this@MainActivity,
                        "Permission Granted now you can read this file",
                        Toast.LENGTH_LONG
                    ).show()
        ...
        ibSave.setOnClickListener{
                if(isReadStorageAllowed()){
                    lifecycleScope.launch{
                        val flDrwaingView: FrameLayout = findViewById(R.id.fl_drawing_view_container)
                        val myBitmap :Bitmap = getBitmapFromView(flDrwaingView)
